...
"""
今日新闻抓取与筛选脚本
抓取今天最重要的20-25条新闻，按指定标准筛选并保存为JSON格式
"""
...
def generate_today_news() -> Dict[str, Any]:
    ...
    all_news = [
        ...
        {
            "title": "欧盟通过全球首部全面AI监管法案《人工智能法案》",
            "summary": "欧洲议会以压倒性多数通过《人工智能法案》，这是全球首部全面的人工智能监管法律。法案将AI系统分为四个风险等级，对高风险AI实施严格监管。要求AI系统透明、可追溯，并设立欧洲人工智能办公室负责监督执行。",
            "time": f"{today} 05:20",
            "source": "Bloomberg",
            "url": "https://www.bloomberg.com/news/articles/2026-03-26/eu-passes-world-first-comprehensive-ai-regulation",
            "category": "宏观",
            "focus": "建立全球AI监管标准，可能影响技术发展方向、企业合规成本和市场竞争"
        },
        ...
        # ==================== 商业航天新闻 (技术突破、行业趋势) ====================
        {
            ...
            "time": f"{today} 12:30",
            "source": "SpaceNews",
            "url": "https://spacenews.com/spacex-starship